...
| [**WUDI-Merging** (`wudi`)](docs/merge_methods.md#wudi-merging-wudi)                                                  | Optimize linear-layer task vectors to reduce expert interference.    |    ≥2    |  ✓   | Data-free merging of related task experts.                      |
